    ...
    public partial class Form1 : Form
    {
        ...
        private void help_Click(object sender, EventArgs e)
        {
            if (helpmenu == false)
            {
                ...
                helpmenu = true;
                helplabel.Font = new Font("", 10);
                helplabel.TextAlign = ContentAlignment.TopLeft;
                helplabel.Text = ("Pro zápis čísel a základní operace +/-/÷/× lze využít numerický blok (numpad)\nPro zbylé operace je nutné použít tlačíka\nK dispozici jsou také klávesové zkratky:\nC - CE (clear - vynulovat)     E - zobrazit výsledek\nDEL - vymazat poslední znak\nPro změnu fontu historie použij tlačítka nad history boxem\nPro výstup z nabídky nápovědy stiskni znovu tlačítko Help");
            }
            else
            {
        ...
        {
            historyfont += 2;
            history.Font = new Font("Segoe UI", historyfont);
        }
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            if (comicsans == false)
            {
                ...
                foreach (Control control in Controls)
                {
                    if (control is Button)
                    {
                        ...
                        button.Font = new Font("Comic Sans MS", 19);
                    }
                }
                history.Font = new Font("Comic Sans MS", historyfont);
                textbox.Font = new Font("Comic Sans MS", 28);
                button23.Font = new Font("Comic Sans MS", 18);
                button14.Font = new Font("Comic Sans MS", 12);
                button15.Font = new Font("Comic Sans MS", 12);
                button17.Font = new Font("Comic Sans MS", 8);
                help.Font = new Font("Comic Sans MS", 10);
                helplabel.Font = new Font("Comic Sans MS", 10);
                button17.Text = "nechci comic sans :(";
            ...
            else
            {
                ...
                foreach (Control control in Controls) 
                {
                    ...
                    {
                        Button button = (Button)control;
                        button.Font = new Font("Segoe UI", 19);
                    }
                }
                history.Font = new Font("Segoe UI", historyfont);
                textbox.Font = new Font("Segoe UI", 28);
                button23.Font = new Font("Segoe UI", 18);
                button14.Font = new Font("Segoe UI", 12);
                button15.Font = new Font("Segoe UI", 12);
                button17.Font = new Font("Segoe UI", 8);
                help.Font = new Font("Segoe UI", 10);
                helplabel.Font = new Font("Segoe UI", 10);
                button17.Text = "mám rád comic sans";
            }
        }
    }
}
